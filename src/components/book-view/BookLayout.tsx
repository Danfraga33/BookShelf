      ...
      <div className="bg-white border-b border-navy-100 px-4 py-2.5 flex items-center gap-3 shrink-0">
        {onToggleMobileSidebar && (
          <button
            ...
            className="md:hidden p-1.5 hover:bg-surface rounded-lg transition-colors duration-200 text-navy-400"
            title="Open chapters"
          >
        ...
        <button
          onClick={onBack}
          className="p-1.5 hover:bg-surface rounded-lg transition-colors duration-200 text-navy-400"
